      ...
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center justify-center rounded-lg border border-red-200 bg-white p-12 text-center">
          ...
          <div className="mt-6 flex gap-3">
            ...
            <Link href="/admin/dashboard" className="inline-flex min-h-11 items-center justify-center rounded-md border border-neutral-300 bg-white px-5 py-3 text-sm font-semibold text-neutral-700 hover:bg-neutral-50">
              Go to Dashboard
            </Link>
          </div>
        </div>
